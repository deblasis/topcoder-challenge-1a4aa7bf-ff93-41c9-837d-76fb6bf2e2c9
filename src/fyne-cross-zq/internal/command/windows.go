...
const (
	...
	windowsImage = "deblasis/fyne-cross:1.1-windows-zq"
)
...
func makeWindowsContext(flags *windowsFlags, args []string) ([]Context, error) {
	...
	for _, arch := range targetArch {
		...
		switch arch {
		case ArchAmd64:
			ctx.Env = append(ctx.Env, "GOOS=windows", "GOARCH=amd64", "CC=x86_64-w64-mingw32-gcc", "CXX=x86_64-w64-mingw32-g++")
		case Arch386:
			ctx.Env = append(ctx.Env, "GOOS=windows", "GOARCH=386", "CC=i686-w64-mingw32-gcc", "CXX=x86_64-w64-mingw32-g++")
		}
